...
* [ ] **AC.2:** Password input enforces minimum 8 characters and shows validation feedback
...
## **User Story : Accessibility & UX**

* **As a** user with accessibility needs
* **I want** the registration form to be accessible and usable
* **So that** I can complete registration without barriers

**Story Points:** 3

✅ **Acceptance Criteria:**

* [ ] **AC.1:** All inputs and buttons are keyboard navigable
* [ ] **AC.2:** Form labels are linked to inputs for screen readers
* [ ] **AC.3:** Error messages are announced for screen readers
* [ ] **AC.4:** Color contrast and font size follow accessibility standards
